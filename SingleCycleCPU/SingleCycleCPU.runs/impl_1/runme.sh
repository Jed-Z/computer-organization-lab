...
HD_PWD='E:/_Vivado/MIPS_CPU_Design/SingleCycleCPU/SingleCycleCPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3_CPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Basys3_CPU.tcl -notrace
