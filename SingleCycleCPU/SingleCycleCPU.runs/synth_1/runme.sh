...
HD_PWD='E:/_Vivado/MIPS_CPU_Design/SingleCycleCPU/SingleCycleCPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3_CPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Basys3_CPU.tcl
