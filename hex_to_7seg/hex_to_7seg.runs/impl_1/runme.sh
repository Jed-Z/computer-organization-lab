...
HD_PWD='E:/_Vivado/MIPS_CPU_Design/hex_to_7seg/hex_to_7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_LEDs.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_LEDs.tcl -notrace
