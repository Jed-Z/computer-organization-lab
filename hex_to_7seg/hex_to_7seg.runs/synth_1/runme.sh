...
HD_PWD='E:/_Vivado/MIPS_CPU_Design/hex_to_7seg/hex_to_7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_LEDs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_LEDs.tcl
